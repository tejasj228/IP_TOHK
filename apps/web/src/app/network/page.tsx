...
const workshopData = {
  "2025": [
    { id: 1, name: "Lopeka Attreja", grade: "Others", city: "Haryana" },
    { id: 2, name: "Kabeer More", grade: "12", city: "Maharashtra" },
    { id: 3, name: "Ananya Srivastava", grade: "12", city: "Maharashtra" },
    { id: 4, name: "Guhan Senthil Kumaran", grade: "9", city: "Tamil Nadu" },
    ...
    { id: 12, name: "Divyank Sarda", grade: "12", city: "Sikkim" },
    { id: 13, name: "Suksham Ghimiray", grade: "12", city: "Sikkim" },
    { id: 14, name: "Pravin Naidu", grade: "12", city: "Sikkim" },
    { id: 15, name: "Nyssha Ladha", grade: "12", city: "Sikkim" },
    { id: 16, name: "Wangchuk Bhutia", grade: "12", city: "Sikkim" },
    { id: 17, name: "Shivaansh Sharma", grade: "10", city: "Haryana" },
    { id: 18, name: "Armaan Uppal", grade: "12", city: "Chandigarh" },
    { id: 19, name: "Ladi Uttej", grade: "Others", city: "Orrisa" },
    { id: 20, name: "Gauransh Khurana", grade: "11", city: "New Delhi" },
    { id: 21, name: "Madhav Rathi", grade: "Others", city: "Gujarat" },
    { id: 22, name: "Ayaan Mohan", grade: "9", city: "Haryana" },
    { id: 23, name: "Meghna Atapaka", grade: "9", city: "Tamilnadu" },
    { id: 24, name: "Rohan Sundas", grade: "12", city: "Sikkim" },
    { id: 25, name: "Adwikaa Kanodia", grade: "9", city: "Delhi" },
    { id: 26, name: "Kiyansh Garg", grade: "11", city: "Delhi" },
    { id: 27, name: "Pranay Mohan", grade: "9", city: "Haryana" },
    { id: 28, name: "VARSITA V.P", grade: "9", city: "Tamil Nadu" },
    { id: 29, name: "Rigsel Nadik", grade: "11", city: "Sikkim" },
    { id: 30, name: "Siddhant Chatterjee", grade: "11", city: "Uttar Pradesh" },
    { id: 31, name: "Sohana Rizal", grade: "12", city: "Sikkim" },
    { id: 32, name: "Adhav Kandasamy", grade: "11", city: "Tamil Nadu" },
    { id: 33, name: "Karma Kazi", grade: "12", city: "Sikkim" },
    { id: 34, name: "Keshav Singh", grade: "10", city: "Delhi" },
    { id: 35, name: "Vir Chowdhry", grade: "11", city: "Haryana" },
    { id: 36, name: "Ranveer Kamboj", grade: "10", city: "Delhi" },
    { id: 37, name: "Aariv Gulshan", grade: "9", city: "Haryana" },
    { id: 38, name: "Tenzing Bhutia", grade: "12", city: "Sikkim" },
    { id: 39, name: "Alok Chettri", grade: "12", city: "Sikkim" },
    { id: 40, name: "Advitiya Yadav", grade: "10", city: "Chandigarh" },
    { id: 41, name: "Sarvagya Jagatram", grade: "11", city: "Uttar Pradesh" },
    { id: 42, name: "Namsella Lachenpa", grade: "12", city: "Sikkim" },
    { id: 43, name: "Lakshit Mishra", grade: "12", city: "Delhi" },
    { id: 44, name: "Archana Chettri", grade: "12", city: "Sikkim" },
    { id: 45, name: "Shambhavi Sharma", grade: "11", city: "Haryana" },
    { id: 46, name: "Aarav Tyagi", grade: "12", city: "Uttar Pradesh" },
    { id: 47, name: "Ari Norbu", grade: "12", city: "Sikkim" },
    { id: 48, name: "Kalsang Barfungpa", grade: "12", city: "Sikkim" },
    { id: 49, name: "Norbu Bhutia", grade: "12", city: "Sikkim" },
    { id: 50, name: "Reedam Dahal", grade: "12", city: "Sikkim" },
  ],
  "2024": [
    { id: 1, name: "Rudra Kothiyal", grade: "11", city: "Karnataka" },
    { id: 2, name: "Aarav Mallick", grade: "11", city: "Maharashtra" },
    { id: 3, name: "Simranpreet Singh", grade: "11", city: "Tamil Nadu" },
    { id: 4, name: "Sridaran Ishanth", grade: "11", city: "Tamil Nadu" },
    { id: 5, name: "Tejas Jain", grade: "11", city: "Uttar Pradesh" },
    { id: 6, name: "Shloak Gupta", grade: "11", city: "Uttar Pradesh" },
    { id: 7, name: "Kisna Garg", grade: "9", city: "Delhi" },
    { id: 8, name: "Ansh Goyal", grade: "9", city: "Delhi" },
    { id: 9, name: "Kanishk Das", grade: "9", city: "Delhi" },
    { id: 10, name: "Dhruv Gandhi", grade: "11", city: "Delhi" },
    { id: 11, name: "Raunak Pahwa", grade: "9", city: "Delhi" },
    { id: 12, name: "Ishaan Sharma", grade: "9", city: "Delhi" },
    { id: 13, name: "Divyanshu Yadav", grade: "11", city: "Uttar Pradesh" },
    { id: 14, name: "Shivam Yadav", grade: "11", city: "Uttar Pradesh" },
    { id: 15, name: "Lakshya Tiwari", grade: "11", city: "Uttar Pradesh" },
    { id: 16, name: "Bipin Gupta", grade: "11", city: "Uttar Pradesh" },
    { id: 17, name: "Vaidehi Vats", grade: "9", city: "Delhi" },
    { id: 18, name: "Vanshika Jain", grade: "10", city: "Karnataka" },
    { id: 19, name: "Keshika Verma", grade: "11", city: "Delhi" },
    { id: 20, name: "Archisha Verma", grade: "12", city: "Gujarat" },
    { id: 21, name: "Ananya Saraogi", grade: "11", city: "Delhi" },
    { id: 22, name: "Alveerah Bashir", grade: "11", city: "Uttar Pradesh" },
    { id: 23, name: "Allu Sairuchi Reddy", grade: "11", city: "Telangana" },
    { id: 24, name: "Tanu Singh", grade: "11", city: "Uttar Pradesh" },
    { id: 25, name: "Pasham Yadav", grade: "11", city: "Telangana" },
    { id: 26, name: "Auroneel Das", grade: "11", city: "Delhi" },
    { id: 27, name: "Tanish Sharma", grade: "11", city: "Delhi" },
    { id: 28, name: "Samarth Kaila", grade: "11", city: "Delhi" },
    { id: 29, name: "Jeetesh Vasisth", grade: "11", city: "Delhi" },
    { id: 30, name: "Arav Shinghal", grade: "9", city: "Delhi" },
    { id: 31, name: "Chirag Kapoor", grade: "12", city: "Delhi" },
    { id: 32, name: "Aarya Rampuria", grade: "9", city: "Uttar Pradesh" },
    { id: 33, name: "Sarah Taneja", grade: "11", city: "Delhi" },
    { id: 34, name: "Mohammad Saifi", grade: "11", city: "Delhi" },
    { id: 35, name: "Divit Haldia", grade: "9", city: "Uttar Pradesh" },
    { id: 36, name: "Devansh Bajpai", grade: "9", city: "Uttar Pradesh" },
    { id: 37, name: "Syed Ahmed Husaini", grade: "11", city: "Delhi" },
    { id: 38, name: "Shaurya Maan", grade: "9", city: "Uttar Pradesh" },
    { id: 39, name: "Sourya Kusuma", grade: "9", city: "Delhi" },
    { id: 40, name: "Abhay Pandey", grade: "9", city: "Delhi" },
    { id: 41, name: "Ranveer Singh", grade: "9", city: "Haryana" },
  ],
  "2023": [
    { id: 1, name: "Riddhi Balasubramaniam", grade: "11", city: "Tamil Nadu" },
    { id: 2, name: "Maaya Madhavan", grade: "9", city: "Tamil Nadu" },
    { id: 3, name: "Ishita Porwal", grade: "9", city: "Tamil Nadu" },
    { id: 4, name: "Aathmika Suresh Kumar", grade: "9", city: "Tamil Nadu" },
    { id: 5, name: "Shivangi Saravanan", grade: "9", city: "Tamil Nadu" },
    { id: 6, name: "Srimathivathani B", grade: "10", city: "Tamil Nadu" },
    { id: 7, name: "Niyanthri Vidhyaprakash", grade: "10", city: "Tamil Nadu" },
    { id: 8, name: "Tisya Gupta", grade: "11", city: "Delhi" },
    { id: 9, name: "Navya Gopinathan", grade: "9", city: "Tamil Nadu" },
    { id: 10, name: "Amirtha Manchari", grade: "10", city: "Tamil Nadu" },
    { id: 11, name: "Srishti Senthil Kumar", grade: "9", city: "Tamil Nadu" },
    { id: 12, name: "Sachitha S R", grade: "10", city: "Tamil Nadu" },
    { id: 13, name: "Amirtha Varshini", grade: "10", city: "Tamil Nadu" },
    { id: 14, name: "Pradakshana.Kumar", grade: "9", city: "Tamil Nadu" },
    { id: 15, name: "Hiral Kothari", grade: "9", city: "Tamil Nadu" },
    { id: 16, name: "Akshara Ramji", grade: "9", city: "Tamil Nadu" },
    { id: 17, name: "Vidula B", grade: "9", city: "Tamil Nadu" },
    { id: 18, name: "Kanishkaa R", grade: "9", city: "Tamil Nadu" },
    { id: 19, name: "Sanchita Dhamotharan", grade: "9", city: "Tamil Nadu" },
    { id: 20, name: "Tarun Venkatesh", grade: "9", city: "Tamil Nadu" },
    { id: 21, name: "Aarush Aggarwal", grade: "11", city: "Uttar Pradesh" },
    { id: 22, name: "Savar Bhatia", grade: "10", city: "Haryana" },
    { id: 23, name: "Vijay Srinesh Kalidass", grade: "9", city: "Tamil Nadu" },
    { id: 24, name: "Dev Shah", grade: "12+", city: "Gujarat" },
    { id: 25, name: "Vineet Desai", grade: "9", city: "Tamil Nadu" },
    { id: 26, name: "Meghmalhar Bhowmick", grade: "9", city: "West Bengal" },
    { id: 27, name: "Jatin Chutani", grade: "12+", city: "Haryana" },
    { id: 28, name: "Manaswin Nagpal", grade: "9", city: "Rajasthan" },
    { id: 29, name: "Kunal Aiyer", grade: "12", city: "Gujarat" },
    { id: 30, name: "Samrat Basak", grade: "10", city: "Haryana" },
    { id: 31, name: "Arya Sanjey Kumaraguru", grade: "9", city: "Tamil Nadu" },
    { id: 32, name: "Tanmay Shah", grade: "9", city: "Tamil Nadu" },
    { id: 33, name: "Adyanth Naveenkumar", grade: "9", city: "Tamil Nadu" },
    { id: 34, name: "Arsh Goyal", grade: "9", city: "Delhi" },
    { id: 35, name: "Ayush Chauhan", grade: "11", city: "Delhi" },
    { id: 36, name: "Mehreen Khanuja", grade: "12", city: "Delhi" },
    { id: 37, name: "Naisha Choudhary", grade: "11", city: "Uttar Pradesh" },
    { id: 38, name: "Anshika Agrawal", grade: "12", city: "Delhi" },
    { id: 39, name: "Kashvi Garg", grade: "10", city: "Uttar Pradesh" },
    { id: 40, name: "Bhuvi Gupta", grade: "11", city: "Delhi" },
    { id: 41, name: "Navya Kautish", grade: "12+", city: "Haryana" },
  ],
  "2022": [
    { id: 1, name: "Vanya Gupta", grade: "10", city: "Maharashtra" },
    { id: 2, name: "Saksham Zutshi", grade: "11", city: "Delhi" },
    { id: 3, name: "Dheeraj Sutram", grade: "12", city: "Tamil Nadu" },
    { id: 4, name: "Naman Soin", grade: "9", city: "Delhi" },
    { id: 5, name: "Kapeesh Ahuja", grade: "9", city: "Delhi" },
    { id: 6, name: "Arnav Nagpal", grade: "9", city: "Delhi" },
    { id: 7, name: "Aanya Navin", grade: "11", city: "Tamil Nadu" },
    { id: 8, name: "Sarthak Agarwal", grade: "11", city: "Delhi" },
    { id: 9, name: "Siddhant Dhunna", grade: "11", city: "Chandigarh" },
    { id: 10, name: "Vaasvi Kuthiala", grade: "9", city: "Chandigarh" },
    { id: 11, name: "Nandini Nithyanandh", grade: "11", city: "Tamil Nadu" },
    { id: 12, name: "Arav Choudhry", grade: "9", city: "Delhi" },
    { id: 13, name: "Ronak Jain", grade: "9", city: "Delhi" },
    { id: 14, name: "Sumanyu Singhal", grade: "9", city: "Delhi" },
    { id: 15, name: "Lakshya Yadav", grade: "11", city: "Chandigarh" },
    { id: 16, name: "Maira Singhal", grade: "10", city: "Delhi" },
    { id: 17, name: "Lakshay Goyal", grade: "9", city: "Chandigarh" },
    { id: 18, name: "Aasmaa Garg", grade: "9", city: "Chandigarh" },
    { id: 19, name: "Piyush Paul", grade: "11", city: "Assam" },
    { id: 20, name: "Rahul Setia", grade: "11", city: "Chandigarh" },
    { id: 21, name: "Krishang Choudhary", grade: "11", city: "Assam" },
    { id: 22, name: "Garvit Rustagi", grade: "9", city: "Delhi" },
    { id: 23, name: "Rajjyoti Talukdar", grade: "11", city: "Assam" },
    { id: 24, name: "Nishtha Agnihotri", grade: "11", city: "Uttar Pradesh" },
    { id: 25, name: "Anurag SIngh", grade: "10", city: "Uttar Pradesh" },
    { id: 26, name: "Ghulam Qadir", grade: "10", city: "Uttar Pradesh" },
    { id: 27, name: "Ayaan Sharma", grade: "9", city: "Delhi" },
    { id: 28, name: "Arnav Goel", grade: "9", city: "Delhi" },
    { id: 29, name: "Suhaan Khurana", grade: "11", city: "Delhi" },
    { id: 30, name: "Siddhi Jairath", grade: "10", city: "Delhi" },
    { id: 31, name: "Amogh Grover", grade: "10", city: "Delhi" },
    { id: 32, name: "Tanisha Singla", grade: "10", city: "Delhi" },
    { id: 33, name: "Stuti Runda", grade: "9", city: "Delhi" },
    { id: 34, name: "Reyansh Juneja", grade: "12", city: "Delhi" },
    { id: 35, name: "Avirat Jain", grade: "11", city: "Delhi" },
  ],
  "2021": [
...
const NetworkPage = () => {
  ...
  const [selectedWorkshop, setSelectedWorkshop] = useState("2025");
